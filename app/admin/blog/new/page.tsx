...
import { createPost, uploadMedia, deleteMedia } from '@/lib/api'
...
export default function NewBlogPostPage() {
  ...
  // Featured image only becomes available after the post is first saved
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between gap-4">
        <div className="flex items-center gap-2 min-w-0">
          ...
          <span className="text-sm font-medium text-zinc-700 truncate">New Post</span>
        </div>
      ...
      <div className="flex gap-6 items-start">
        ...
        <div className="w-72 flex-shrink-0 space-y-4">
          ...
          <div className="bg-white rounded-lg border border-zinc-200 p-4 space-y-3">
            ...
            {!postId ? (
              <p className="text-xs text-zinc-400 italic">Save the post first to add an image.</p>
            ) : (
              <>
          ...
          <div className="bg-white rounded-lg border border-zinc-200 p-4 space-y-3">
            ...
            <div className="flex items-center justify-between">
              <Label htmlFor="new-is-published" className="text-sm text-zinc-700 cursor-pointer">
                Published
              </Label>
              <Switch
                id="new-is-published"
